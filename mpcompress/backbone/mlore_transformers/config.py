...
def parse_task_dictionary(db_name, task_dictionary):
    ...
    if 'include_scene' in task_dictionary.keys() and task_dictionary['include_scene']:
        # Scene Classification
        #assert(db_name == 'NYUD')
        tmp = 'scene'
        task_cfg.NAMES.append(tmp)
        task_cfg.NUM_OUTPUT[tmp] = 27
...
def create_config(exp_file, params):
    ...
    db_root = '/mnt/netdisk/Datasets/'

    db_names = {'PASCALContext': '117-PASCALContext/PASCALContext', 'NYUD_MT': '/mnt/netdisk/Datasets/132-NYUDv2/NYUDv2'}
    db_paths = {}
