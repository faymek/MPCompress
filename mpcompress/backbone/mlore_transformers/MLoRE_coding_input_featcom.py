...
default_cfgs = {
    ...
    'vit_tiny_patch16_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'Ti_16-i21k-300ep-lr_0.001-aug_none-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz', custom_load=True,
        input_size=(3, 384, 384), crop_pct=1.0),
    'vit_small_patch32_224': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_32-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz', custom_load=True),
    'vit_small_patch32_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_32-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz', custom_load=True,
        input_size=(3, 384, 384), crop_pct=1.0),
    'vit_small_patch16_224': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz', custom_load=True),
    'vit_small_patch16_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_384.npz', custom_load=True,
        input_size=(3, 384, 384), crop_pct=1.0),
    'vit_base_patch32_224': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'B_32-i21k-300ep-lr_0.001-aug_medium1-wd_0.03-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.03-res_224.npz', custom_load=True),
    ...
    'vit_base_patch16_224': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_224.npz', custom_load=True),
    'vit_base_patch16_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0--imagenet2012-steps_20k-lr_0.01-res_384.npz', custom_load=True,
        input_size=(3, 384, 384), crop_pct=1.0),
    ...
    'vit_large_patch16_384': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/'
            'L_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.1-sd_0.1--imagenet2012-steps_20k-lr_0.01-res_384.npz', custom_load=True,
        input_size=(3, 384, 384), crop_pct=1.0),

    # patch models, imagenet21k (weights from official Google JAX impl)
    'vit_tiny_patch16_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/Ti_16-i21k-300ep-lr_0.001-aug_none-wd_0.03-do_0.0-sd_0.0.npz', custom_load=True,
        num_classes=21843),
    'vit_small_patch32_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/S_32-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0.npz', custom_load=True,
        num_classes=21843),
    'vit_small_patch16_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/S_16-i21k-300ep-lr_0.001-aug_light1-wd_0.03-do_0.0-sd_0.0.npz', custom_load=True,
        num_classes=21843),
    'vit_base_patch32_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/B_32-i21k-300ep-lr_0.001-aug_medium1-wd_0.03-do_0.0-sd_0.0.npz', custom_load=True,
        num_classes=21843),
    'vit_base_patch16_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/B_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.0-sd_0.0.npz', custom_load=True,
        num_classes=21843),
    'vit_large_patch32_224_in21k': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_vit_large_patch32_224_in21k-9046d2e7.pth',
        num_classes=21843),
    'vit_large_patch16_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/augreg/L_16-i21k-300ep-lr_0.001-aug_medium1-wd_0.1-do_0.1-sd_0.1.npz', custom_load=True,
        num_classes=21843),
    'vit_huge_patch14_224_in21k': _cfg(
        url='https://storage.googleapis.com/vit_models/imagenet21k/ViT-H_14.npz', custom_load=True,
...
class FeatCompression(CompressionModel):
    def __init__(self,feat_dims, prompt_dims=64, N=1024,M=512):
        '''
        ...
        self.g_a = nn.Sequential(ResidualBlockWithStride(feat_dims, N, 1), 
                                   ResidualBlockWithStride(N, N, 1),
                                   ResidualBlockWithStride(N, N, 1),
                                   ResidualBlockWithStride(N, M, 1),
                                   )
        self.g_s = nn.Sequential(ResidualBlockUpsample(M, N, 1),
    ...
    def forward(self, x, target=None):
        ...
        if target is not None:
            mse = torch.nn.functional.mse_loss(x_hat, target.detach()) #x需要detach吗？
        else:
            mse = torch.nn.functional.mse_loss(x_hat, x.detach()) #x需要detach吗？
        #print(y.abs().mean(), latent_means.abs().mean(), x.abs().mean(), x_hat.abs().mean())
...
class MLoRE(nn.Module):
    ...
    def __init__(self, p, select_list, img_size=224, patch_size=16, in_chans=3, embed_dim=768, depth=12,
        ...
        #self.select_list = [6,9]

        self.num_layers = 4
        assert len(self.select_list) == self.num_layers-1 
        ...
        for i_layer in range(self.num_layers):
            self.fea_fuse.append(nn.Sequential(nn.Conv2d(embed_dim, final_embed_dim, kernel_size=1, stride=1),BatchNorm2d(final_embed_dim), nn.GELU(),nn.Conv2d(final_embed_dim, final_embed_dim, kernel_size=3, stride=1,padding=1)))

        #self.task_mask = MaskFusion(final_embed_dim, self.resolution)
        self.compress = FeatCompression(embed_dim)
    ...
    def get_features(self,x):
        ...
        features = []
        self.return_feature_idx = 3 #self.select_list[0]
        for idx, blk in enumerate(self.blocks):
            x, attn_weight = blk(x)
            x, attn_weight = x, attn_weight
            if idx + 1 == self.return_feature_idx: 
                features = x.clone()
                break
        return features
        ...
        for idx, blk in enumerate(self.blocks):
            ...
            if idx + 1 in self.select_list: 
                ...
                for task_list in episode_tasks:
                    tasks = ''.join(task_list)
                    last_feat[tasks] += self.fea_fuse[il](xx)    
        xx = rearrange(self.norm(x), 'b (h w) c -> b c h w', h=self.resolution[0], w=self.resolution[1])
        for task_list in episode_tasks:
            tasks = ''.join(task_list) 
            last_feat[tasks] += self.fea_fuse[self.num_layers-1](xx)
            last_feat[tasks] /= self.num_layers
...
if __name__ == '__main__':
    img = torch.randn((1,768,16,16)).cuda()
    model = FeatCompression(768).cuda()
    #model2 = MLoRE_vit_large_patch16_384(p=p, pretrained=True, drop_path_rate=0.15, img_size=p.TRAIN.SCALE)
