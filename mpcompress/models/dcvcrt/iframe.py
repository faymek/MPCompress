...
class DMCI(DmcCompressionModel):
    def __init__(self, N=256, z_channel=128, use_yuv=True, load_path=None):
    ...
    def compress(self, x, qp=0, ec_part=1, **kwargs):
        self.entropy_coder.set_use_two_entropy_coders(ec_part)
