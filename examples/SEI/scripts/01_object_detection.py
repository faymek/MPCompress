...
processor = DetrImageProcessor.from_pretrained(
    "/home/gabriel/checkponits/detr-resnet-50", revision="no_timm"
)
...
# # random50
# img_dir = "/home/gabriel/SEI_work/data/img_test_random50"
...
output_dir = f"{base_dir}/data/SEI_sel100"
os.makedirs(output_dir, exist_ok=True)
for img_path in tqdm(img_files):
    infer_img_detection(img_path, output_dir)
